...
<head>
    ...
    <title>Магазин en FISHING</title>
...
<div id="container">
    <div class="jcarousel-wrapper">
        <div class="jcarousel">
            <ul>
                <li><a><img src="http://images.enfishing.ru/en/carousel/image_carousel_1.jpg"></a></li>
                <li><a><img src="http://images.enfishing.ru/en/carousel/image_carousel_2.jpg"></a></li>
                <li><a><img src="http://images.enfishing.ru/en/carousel/image_carousel_3.jpg"></a></li>
                <li><a><img src="http://images.enfishing.ru/en/carousel/image_carousel_4.jpg"></a></li>
            </ul>
        </div>

        <p class="photo-credits">
            <a href="http://enfishing.ru">en FISHING</a>
        </p>
