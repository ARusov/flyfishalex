...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="${lang.resources}/resources/css/vision/product.css"/> ">
    ...
    <title>${product.name} в магазине Vision Fishing</title>
</head>
<body>
                            ...
                            <div class="product-image">
                                <c:choose>
                                    <c:when test="${not empty product.image}">
                                        <img width="300px" src="http://images.visionfishing.ru/products/${product.id}/${product.image}">
                                    </c:when>
                                    <c:otherwise>
