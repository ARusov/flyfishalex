...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${lang.resources}/resources/css/vision/jcarousel.basic.css">
    ...
    <title>Магазин VISION FISHING</title>
...
<div id="container">
    <div class="jcarousel-wrapper">
        ...
        <p class="photo-credits">
            <a href="http://visionfishing.ru">VISION FISHING</a>
        </p>
