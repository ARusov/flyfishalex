...
<div id="footer">
    <div id="footer-block">
        <div class="footer-menu">
            <ul>
                ...
                <li><a href="${lang.context}/about/payment" title="О рыболовном интернет магазине">Оплата</a></li>
                <li><a href="${lang.context}/about/delivery" title="Доставка рыболовных товаров">Доставка</a></li>
            </ul>
        </div>
        <div class="footer-menu">
            <ul>
    ...
    <div id="copyright">
        <span>РЫБОЛОВНЫЙ ИНТЕРЕТ МАГАЗИН. <a href="http://visionfishing.ru/">VISION FISHING</a>. ВСЕ ПРАВА ЗАЩИЩЕНЫ &#169; ${year}.</span>
    </div>
