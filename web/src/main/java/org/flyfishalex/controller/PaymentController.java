...
public class PaymentController {
    ...
    YandexCheckResponse checkDemo(@RequestParam Map<String, Object> yandexRequestParams) {
        ...
        try {
            ...
            Order order= orderService.getOrder(orderId);
            if(order!=null){
                long totalPrice=Long.getLong((String) yandexRequestParams.get(YandexRequestParams.orderSumAmount));
                if(totalPrice==order.getDeliveryPrice()+order.getFinalPrice()){
